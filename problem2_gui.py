...
class Problem2GUI:
    def __init__(self, root):
        ...
        ttk.Label(file_frame, text="Enter txt File Name:").pack(anchor="w")
    ...
    def execute_apriori(self, file_name, confidence_threshold, sup_count, percentage):
        try:
            ...
            df = logic.load_dataset_problem2(file_name, percentage)
            vertical_data, filtered_vertical_data = logic.generate_vertical_data_problem2(df, sup_count)
